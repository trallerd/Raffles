...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { contact_id: @phone.contact_id, number: @phone.number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { contact_id: @phone.contact_id, number: @phone.number } }
