...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { description: @type.description, inicial_number: @type.inicial_number, step: @type.step, ticket_quantities: @type.ticket_quantities } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { description: @type.description, inicial_number: @type.inicial_number, step: @type.step, ticket_quantities: @type.ticket_quantities } }
